...
*   05/14/2024 -- Changed myStrIntDict ages (lines 85-93) to make them more up to date.
*/
...
int main() {
	...
	cout << "<Justin Cooper> -- CSCN 215 Programming Assignment 1 -- Bag Dictionary" << endl << endl;
	...
	// FIND: test for myIntStrDict.search
	int intKey = 40;
	strData = "ERROR!!!";
	...
	myStrIntDict.insert("Terri", 69);
	myStrIntDict.insert("Beth", 65);
	myStrIntDict.insert("Jeremy", 31);
	myStrIntDict.insert("Nathan", 29);
	myStrIntDict.insert("Zipper", 13);
	myStrIntDict.insert("Button", 13);
	myStrIntDict.insert("Chai", 1);
	myStrIntDict.insert("Kiwi", 18);
	myStrIntDict.insert("Masoala", 21);
